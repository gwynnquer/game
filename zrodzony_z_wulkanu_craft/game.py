...
class Game():
    def __init__(self):
        ...
        self.game_canvas = pygame.Surface(
            (game_window_settings.MainWindow.WIDTH_2, game_window_settings.MainWindow.HEIGHT_2))
        self.screen = game_window_settings.main_game_window_settings()
    ...
    def load_assets(self):
        ...
        self.font = pygame.font.Font(os.path.join(
            self.font_dir, "PressStart2P-vaV7.ttf"), 20)
